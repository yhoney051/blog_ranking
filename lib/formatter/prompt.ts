...
### quote (인용구 6종)
- quotemark (따옴표): 소제목, 섹션 시작 (큰 따옴표 ❝ 장식 + 굵은 텍스트)
- vertical-line (버티컬 라인): 중요 포인트, 핵심 강조
- speech-bubble (말풍선): 대화체, 독자에게 말 거는 문장
- line-quote (라인&따옴표): 인용, 공식 안내, 행동 유도(CTA) (꺾쇠 ┌┘ + 가운데 정렬)
- postit (포스트잇): 독자 공감, 감성적 문장, 팁
- frame (프레임): 목차/요약 리스트, 핵심 정보 박스
...
## 문장 역할별 도구 선택 기준
- 소제목/섹션 시작 → quotemark 인용구 (큰 따옴표 ❝ 스타일). heading은 사용하지 마세요.
...
## bold / highlight / bold+highlight 사용 기준
- bold만: 키워드 단어 1~3개 (예: "성형외과 전문의", "재수술")
- highlight만: 문장 중 강조할 구절 3~8어절 (예: "이때 가장 중요한 것은 성형외과 전문의 자격증을 보유한 의료진인지 확인하는 것")
- bold+highlight 동시: 글 전체에서 가장 중요한 핵심 메시지 1~2곳만 (예: "첫 수술의 문제 원인을 명확히 진단할 수 있는 역량")
- 전체 원고에서 highlight 사용은 3~5회로 제한하세요. 남용하면 효과가 없어집니다.

## 규칙
1. 원문 텍스트를 절대 수정하지 마세요. 글자 하나도 바꾸지 마세요.
2. 모든 문장을 5~7어절(약 15~20자)마다 반드시 줄바꿈(\n)하세요. 이것은 가장 중요한 규칙입니다.
   예시1: "그런 이유 때문에\n눈재수술을 하기 위해\n병원을 방문하시는 환자분들은\n더욱 신중하게 병원과 의사를\n선택하려는 경향이 있지요."
   예시2: "위 3가지 요소를 기준으로\n좋은 성형외과를 선택하는 방법을\n소개드려보도록 하겠습니다."
   예시3: "안녕하세요.\n15년차 성형외과 전문의,\n닥터팡교입니다."
