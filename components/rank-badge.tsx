...
export function RankBadge({ current, previous }: Props) {
  ...
  const styles = {
    new: 'bg-[#c8e600]/20 text-slate-700 dark:bg-[#c8e600]/10 dark:text-slate-400',
    up: 'bg-[#c8e600]/15 text-slate-700 dark:bg-[#c8e600]/10 dark:text-slate-400',
    down: 'bg-slate-100 text-slate-500 dark:bg-slate-800 dark:text-slate-400',
