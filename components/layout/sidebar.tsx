...
import { LayoutDashboard, Settings, ChevronLeft, ChevronRight, CreditCard, Crown, TrendingUp, Megaphone } from "lucide-react";
...
const navItems = [
  ...
  { icon: Megaphone, label: "대행 문의", href: "/contact" },
];
