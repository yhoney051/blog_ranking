  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5 px-4 h-14 border-b border-sidebar-border">
        <div className="flex items-center justify-center h-9 w-9 rounded-lg bg-[#c8e600] text-slate-900 dark:bg-[#c8e600] dark:text-slate-900 shrink-0">
          ...
          const linkContent = (
            <Link
              ...
              className={cn(
                ...
                active
                  ? "bg-[#c8e600]/10 text-slate-800 dark:bg-[#c8e600]/10 dark:text-slate-300"
      ...
      {profile && !collapsed && (
        <div className="px-3 pb-2">
          {isPro ? (
            <div className="rounded-xl bg-[#c8e600]/10 dark:bg-[#c8e600]/10 border border-[#c8e600]/20 dark:border-[#c8e600]/15 p-3 text-center">
            ...
            <Link href="/dashboard/billing">
              <div className="rounded-xl bg-[#c8e600] p-3.5 text-slate-900 cursor-pointer hover:opacity-90 transition-opacity">
        ...
        <div className={cn("px-3 py-3", collapsed && "px-2")}>
          {collapsed ? (
            <Tooltip>
              <TooltipTrigger
                render={
                  <div className="mx-auto flex items-center justify-center h-9 w-9 rounded-full bg-[#c8e600]/15 text-slate-800 dark:bg-[#c8e600]/10 dark:text-slate-300 text-xs font-bold cursor-default">
            ...
            <div className="flex items-center gap-2.5">
              <div className="flex items-center justify-center h-9 w-9 rounded-full bg-[#c8e600]/15 text-slate-800 dark:bg-[#c8e600]/10 dark:text-slate-300 text-xs font-bold shrink-0">
                {profile.email.slice(0, 2).toUpperCase()}
              </div>
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  <Badge
                    ...
                    className={cn(
                      ...
                      isPro && "bg-[#c8e600]/20 text-slate-800 hover:bg-[#c8e600]/20 dark:bg-[#c8e600]/10 dark:text-slate-300"
                    )}
                  >
                    {isPro ? "Pro" : "무료"}
                  </Badge>
